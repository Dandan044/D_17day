...
export const ENDINGS: EndingDef[] = [
  ...
  },
  {
    ...
    priority: 92,
    cause: ['袭击'],
    text: '门没挡住。他们有六个人和一把液压剪。整个过程不到四分钟。\n你最后想起的事很奇怪——是你在第二天犹豫过要不要把那笔钱花在加固门上。',
    relics: 0,
  },
  {
    id: 'death_air',
  ...
  },
  {
    ...
    priority: 94,
    cause: ['一氧化碳中毒'],
    text: '你把门窗用胶带封死后，屋里几乎不进风。那天夜里你点了炉子。没有烟味。头只是闷，像有人用掌心按着太阳穴。\n五金店王老板从柜台底下摸过一个白色小圆盘，巴掌大，一氧化碳报警器，六十八块。你摇了头。\n你后来没有再醒。炉子还亮着。窗缝上的胶带没动。',
    relics: 5,
    unlock: ['blueprint_ventilation'],
  },
  {
