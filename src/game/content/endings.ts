...
export const ENDINGS: EndingDef[] = [
  ...
  },
  {
    ...
    text: '你没有让任何人进来过。\n四十九天里你说过的话总共不超过一百句，其中大部分是对自己说的。你活下来了，用最少的变量，最少的风险，最少的人。\n第四十九天，你在本子上画完最后一格。你抬头看了一眼门口——那里从来没有别人的脚印。\n你说不清这是胜利，还是只是一种精确的孤独。',
    relics: 150,
  ...
  },
  {
    ...
    priority: 90,
    cause: ['失温'],
    text: '最危险的阶段不是发抖，是停止发抖。\n那天夜里你觉得暖和了，甚至想把外套脱掉。这是身体最后的一个玩笑。\n你在自己搭的那个"保温核心房"里睡着了，外面是零下十九度。',
    relics: 0,
  },
  {
    id: 'death_radiation',
