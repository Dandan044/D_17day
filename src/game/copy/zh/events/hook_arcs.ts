...
export const data = {
  ...
  "hook_follow_raid": {
    "main": {
      ...
      "body": "门框上有一道新痕。你分不清是外人留下的，还是自己撞的。\n锤子还在原处。",
      "choice": {
        "fix_frame": {
          "label": "修门框",
        ...
        "keep_scar": {
          "label": "留下当提醒",
          "log": "出门时你会碰到那道痕。木屑还沾在指缝。"
        },
        "skip": {
          "label": "什么都不做",
          "log": "你在门框上挂了块布。第一眼看不见那道痕。"
        }
      }
    }
  },
  ...
  "hook_follow_rest": {
    "main": {
      "title": "你睡着了，中间醒了一次",
      "body": "醒的时候你以为门开了。门链还扣着，猫眼里楼道是黑的。\n你听了半分钟，没有脚步。",
      "choice": {
        "up": {
          "label": "起来确认门锁",
  ...
  "hook_follow_haul": {
    "main": {
      ...
      "body": "包底多了一件东西，巴掌大。你不记得捡过。在暗处抓错的可能性更大。\n你把它拿到灯下看。",
      "choice": {
        "keep": {
          "label": "留下，当运气",
  ...
  "hook_echo_oldflags": {
    ...
    "stranger": {
      ...
      "body": "那张脸你还记得。敲门时你会先对上猫眼，再决定开不开。",
      "choice": {
        "lock": {
          "label": "以后更慢地开门",
          "log": "猫眼你看了三遍。第三遍才拧锁。"
    ...
    "notebook": {
      "title": "笔记本里有一页你不敢再读",
      "body": "字是你的笔迹。内容你不敢再对第二遍。你把那一页折了角，塞进本子最里面。",
      "choice": {
        "read": {
          "label": "读完",
          "log": "你读完了。纸角按平了，字不再糊。"
    ...
    "dj": {
      ...
      "body": "有时你会把收音机拧到那个频率，听沙沙声，想着他还在播下一首歌。",
      "choice": {
        "listen": {
          "label": "再听一次空频",
    ...
    "crossed": {
      ...
      "body": "肥皂很普通。洗完手，指甲缝里的灰淡了一点。那天你碰过的是什么，你自己记得。",
      "choice": {
        "wash": {
          "label": "多洗一遍",
          "log": "你又洗了一遍。指甲缝干净了。"
    ...
    "rescue": {
      ...
      "body": "你试过那个呼号，没有人接。耳机里只有电流声。你会再试，但今天先把电台关掉。",
      "choice": {
        "retry": {
          "label": "再试一次",
    ...
    "abandoned": {
      ...
      "choice": {
        "wake": {
          "label": "醒来后把梦写下来",
          "log": "写下来之后，梦里的门牌号你对照过，对不上现在这扇。"
        },
        "skip": {
          "label": "什么都不做",
          "log": "你醒来时口袋还是空的。门钥匙只有这一把。"
        }
      }
    },
    "sump": {
    ...
    "fam_found": {
      ...
      "choice": {
        ...
        "skip": {
          "label": "什么都不做",
          "log": "收音机关着。最后那条频率写在旁边纸上。"
        }
      }
    },
    "fam_unk": {
      "title": "你还不知道他们在哪",
      "body": "没有地址，也没有新消息。你想写信，又不知道往哪寄。信封还在抽屉里，空白的。",
      "choice": {
        "write": {
          "label": "写信，即使没有地址",
    ...
    "convoy_f": {
      ...
      "choice": {
        ...
        "skip": {
          "label": "什么都不做",
          "log": "假消息你不再听。你还在这间屋子里，门还锁着。"
        }
      }
    },
    "property": {
      "title": "你跟物业做过的那个交易，收据已经皱了",
      "body": "皱收据你还留着。门会不会开，它管不了。",
      "choice": {
        "keep": {
          "label": "夹进贴身口袋",
          "log": "纸贴着胸口。收据还在。"
