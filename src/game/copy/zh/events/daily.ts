...
export const data = {
  ...
  "daily_debt_repaid": {
    "returns": {
      ...
      "body": "腿还有点跛，但能走。他在街口站了很久才往这边来，一路上回头看了好几次。\n\"我回去把车找到了，\"他说，把登山包放在门里侧的地板上，\"里面的东西还在。这些你拿着。\"\n包的侧袋鼓着，看不出装的什么。",
      "choice": {
        "accept": {
          "label": "收下",
          "log": "包里是罐头、药、两桶汽油和一把工具。你收完东西，站在门口看着他拐过街口，才把门关上。"
        }
      }
    }
  },
  "daily_maintenance": {
    ...
    "filter_dying": {
      "title": "滤芯已经变色了",
      "body": "拆下来看，原本白色的部分变成了灰褐，捏一下会掉粉。\n它还在工作，但效率已经不到一半。要换就得动用手里那只备用滤芯，或者继续拖。",
      "choice": {
        "replace": {
          "label": "换上备用滤芯",
          "log": "你拆开报纸裹着的备用滤芯，把新芯卡到位。旧芯捏在手里一掉就是一片灰，你把它扔进了垃圾袋。"
        },
        "clean": {
          "label": "拆开清洗，能延一点",
          "log": "你把滤芯反冲洗了三遍，水从黑色慢慢变成灰色。该掉粉还是掉粉，能拖几天是几天。"
        },
        "accept": {
          "label": "让它撑到彻底不行",
  ...
  "daily_fuel_choice": {
    "burn_what": {
      ...
      "choice": {
        ...
        "burn_furniture": {
          "label": "烧家具",
          "log": "你先烧了书架，抽出来一本一本烧，起先是挑着烧，后来就不看名字了。然后是餐桌的两条腿。火很旺，屋里第一次暖了。"
        },
        "burn_all": {
          "label": "今晚烧足，明天再想办法",
